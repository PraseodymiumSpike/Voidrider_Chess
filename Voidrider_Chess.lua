...
function promotion_rank(board,file,player)
 --returns the rank on which a player's pawn can promote
...
function update_board(board,history,starting_square,ending_square,plays_left)
 ...
 if piece_on_square(board,ending_file,ending_rank).type=="Pawn" and ending_rank==promotion_rank(board,ending_file,piece_on_square(board,ending_file,ending_rank).color) then
